...
Este módulo implementa un controlador PID para ajustar la señal de control del solenoide,
utilizando el modelo físico implementado en solenoid_model.
"""
...
class SolenoidController:
    ...
    def update(self, I, n, R, dt=0.1):
        """
        Ejecuta una simulación del modelo del solenoide y actualiza la señal de control.
        ...
        """
        t, sol = simulate_solenoid(I, n, R, initial_state=[0, 0], t_end=dt, num_points=2)
        measured_Bz = sol[-1, 1]  # Tomamos el último valor de B_z
...
if __name__ == "__main__":
    ...
    print(f"Señal de control: {control_signal:.3f}, Bz medido: {measured_Bz:.6f} T")
