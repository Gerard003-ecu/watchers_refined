...
class TestControlEndpoint:
    ...
    def test_set_control_signal_success(self, client):
        ...
        response = client.post(
            "/api/control", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_set_control_signal_malformed_json(self, client):
        ...
        # WHEN
        response = client.post(
            "/api/control", data=malformed_json, content_type="application/json"
        )
...
class TestCommandEndpoint:
    ...
    def test_command_set_mode_to_battery_succeeds(self, client):
        ...
        # WHEN
        response = client.post(
            "/api/command", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_command_trigger_discharge_succeeds(self, client):
        ...
        client.post(
            "/api/command",
            data=json.dumps({"command": "set_mode", "value": "battery"}),
