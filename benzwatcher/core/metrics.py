...
REACTIVATION_SUCCESS = Counter(
    "benzwatcher_success_total", "Total de reacciones catalíticas exitosas"
)

# Contador para las reacciones fallidas
REACTIVATION_FAILURE = Counter(
    "benzwatcher_failure_total", "Total de reacciones catalíticas fallidas"
)

# Histograma para medir el tiempo de reacción (en segundos)
REACTION_TIME = Histogram(
    "benzwatcher_reaction_time_seconds", "Tiempo de reacción en BenzWatcher"
)
